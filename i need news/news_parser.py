...
news_dumps.write(news_loader.load_news().to_json())
...
news_dumps.write(news_loader.load_news().to_json())
news_loader = AsyncNewsLoader(CONSUMER_DISCRETIONARY_DOMAINS, keyword="cosumer", start_date="2025-03-31", end_date="2025-06-30")
news_dumps.write(news_loader.load_news().to_json())
news_loader = AsyncNewsLoader(CONSUMER_STAPLES_DOMAINS, keyword="cosumer", start_date="2025-03-31", end_date="2025-06-30")
news_dumps.write(news_loader.load_news().to_json())
